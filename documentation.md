...
- **Frame-lagged pipelining.** A frame's transform-and-lighting runs concurrently with rasterization of the previous frame and with physics for the current frame. The split raster/pool wait lets the T&L bin-merge tail overlap overlays and present.
