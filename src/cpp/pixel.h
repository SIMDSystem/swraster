...
static inline uint32_t pack_rgb_fast(PixelFormat* format, uint8_t r, uint8_t g, uint8_t b) {
...
static inline void unpack_rgb_fast(uint32_t pixel, PixelFormat* format,
...
static inline void add_pixel_rgb(Pixel32* row_pixels, int x, PixelFormat* format,
